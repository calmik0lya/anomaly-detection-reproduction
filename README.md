...
**PatchCore, PaDiM, STFPM, SimpleNet, DRAEM**. 
...
Все параметры запуска вынесены из кода в YAML-конфиги в `configs/` — по одному файлу на модель
...
Сводные метрики по классу `bottle` для всех пяти моделей в
